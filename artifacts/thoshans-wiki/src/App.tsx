...
/* ── Globe icon with line-draw animation ──────────────────────────────── */
...
function Home() {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-between overflow-hidden"
      ...
      {/* Dark curtain that lifts on load */}
      {phase !== "done" && (
      ...
      <div className="relative flex flex-col items-center justify-center flex-1 w-full px-6"
        ...
        {/* Browse link */}
        <a href="#articles" className="mt-5 flex items-center gap-2 transition-opacity hover:opacity-80"
          style={{
